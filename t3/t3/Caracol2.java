...
public class Caracol2 implements Runnable {
	...
	public static void main(String[] args) {
		Caracol2 caracol1 = new Caracol2(0.02, "Caracol 1");
		Caracol2 caracol2 = new Caracol2(0.02, "Caracol 2");
		Caracol2 caracol3 = new Caracol2(0.02, "Caracol 3");
		Caracol2 caracol4 = new Caracol2(0.02, "Caracol 4");
		Caracol2 caracol5 = new Caracol2(0.02, "Caracol 5");
